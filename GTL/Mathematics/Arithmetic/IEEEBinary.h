...
namespace gtl
{
    ...
    public:
        ...
        // Special constants.
        static int32_t constexpr NUM_ENCODING_BITS = NumBits;
        static int32_t constexpr NUM_EXPONENT_BITS = NumBits - Precision;
        static int32_t constexpr NUM_SIGNIFICAND_BITS = Precision;
        static int32_t constexpr NUM_TRAILING_BITS = Precision - 1;
        static int32_t constexpr EXPONENT_BIAS = (1 << (NUM_EXPONENT_BITS - 1)) - 1;
        static int32_t constexpr MAX_BIASED_EXPONENT = (1 << NUM_EXPONENT_BITS) - 1;
        static int32_t constexpr MIN_SUB_EXPONENT = 1 - EXPONENT_BIAS;
        static int32_t constexpr MIN_EXPONENT = MIN_SUB_EXPONENT - NUM_TRAILING_BITS;
        static int32_t constexpr SIGN_SHIFT = NumBits - 1;
