...
namespace gte
{
    ...
    template class CurveExtractorTriangles<int8_t, float>;
    template class CurveExtractorTriangles<int16_t, float>;
    template class CurveExtractorTriangles<int32_t, float>;
    ...
    template class CurveExtractorTriangles<int8_t, double>;
    template class CurveExtractorTriangles<int16_t, double>;
    template class CurveExtractorTriangles<int32_t, double>;
}
