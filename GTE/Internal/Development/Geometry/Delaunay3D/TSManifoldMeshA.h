...
namespace gte
{
    ...
    public:
        ...
        virtual ~TSManifoldMeshA() = default;

        TSManifoldMeshA(TCreator tCreator = nullptr, SCreator sCreator = nullptr)
            :
        ...
        TSManifoldMeshA(TSManifoldMeshA const& mesh)
        {
            *this = mesh;
        }

        TSManifoldMeshA& operator=(TSManifoldMeshA const& mesh)
        {
            Clear();
