...
namespace gte
{
    ...
    public:
        ...
        bool operator()(size_t numVertices, Vector3<T> const* vertices)
        {
            ...
            IntrinsicsVector3<T> info(static_cast<int>(mNumVertices), mVertices, zero);
            if (info.dimension == 0)
            {
        ...
        inline TSManifoldMeshA const& GetGraph() const
        {
            return mGraph;
        }
    ...
    private:
        ...
        // Convenient renaming.
        typedef TSManifoldMeshA::Tetrahedron Tetrahedron;
