...
#include "DistOrientedBox3Quad3.h"
#include <Mathematics/DistOrientedBox3Cone3.h>
#include <random>
using namespace gte;

class TestDistBoxConeWindow3 : public Window3
{
public:
    TestDistBoxConeWindow3(Parameters& parameters);
...
private:
    ...
    DistanceOrientedBox3Quad3<float> mQuery;
};
