...
// File Version: 8.2.2026.01.12

#include "ProjectTemplate.h"
#include "ProjectTemplate.v18.h"
#include <string>

TemplateV18::TemplateV18(std::string const& gteRelativePath)
    :
    Template(gteRelativePath)
{
}

std::string const TemplateV18::msGTMathematicsGUID("0CADDB12-31D9-4F60-A8C0-678D1773DA03");
std::string const TemplateV18::msGTGraphicsGUID("B15CB711-F650-4063-9C7C-E7A5F88139A2");
std::string const TemplateV18::msGTGraphicsDX11GUID("00DEFF42-0F7C-4A7C-9C1F-59322B9E9004");
std::string const TemplateV18::msGTApplicationsDX11GUID("8BB237C2-2D3A-41AD-9B98-A35BA75D5DEA");
std::string const TemplateV18::msGTGraphicsGL46GUID("7373CB9F-6595-4FA4-9500-88985A74F0E7");
std::string const TemplateV18::msGTApplicationsGL46GUID("C67471F4-761E-4292-A811-B1FA78E60C21");

std::string const TemplateV18::msSolutionLines =
R"raw(Microsoft Visual Studio Solution File, Format Version 12.00
# Visual Studio Version 18
VisualStudioVersion = 18.1.11312.151 d18.0
MinimumVisualStudioVersion = 10.0.40219.1
Project("{8BC9CEB8-8B4A-11D0-8D11-00A0C91BC942}") = "_PROJECT_NAME__GRAPHICS_API_.v18", "_PROJECT_NAME__GRAPHICS_API_.v18.vcxproj", "{_PROJECT_GUID_}"
EndProject
Project("{2150E333-8FDC-42A3-9474-1A3956D46DE8}") = "Required", "Required", "{_REQUIRED_GUID_}"
EndProject
Project("{8BC9CEB8-8B4A-11D0-8D11-00A0C91BC942}") = "GTMathematics.v18", "_GTE_RELATIVE_PATH_GTMathematics.v18.vcxproj", "{_GTMATHEMATICS_GUID_}"
EndProject
Project("{8BC9CEB8-8B4A-11D0-8D11-00A0C91BC942}") = "GTGraphics.v18", "_GTE_RELATIVE_PATH_GTGraphics.v18.vcxproj", "{_GTGRAPHICS_GUID_}"
EndProject
Project("{8BC9CEB8-8B4A-11D0-8D11-00A0C91BC942}") = "GTGraphics_GRAPHICS_API_.v18", "_GTE_RELATIVE_PATH_GTGraphics_GRAPHICS_API_.v18.vcxproj", "{_GTGRAPHICSAPI_GUID_}"
EndProject
Project("{8BC9CEB8-8B4A-11D0-8D11-00A0C91BC942}") = "GTApplications_GRAPHICS_API_.v18", "_GTE_RELATIVE_PATH_GTApplications_GRAPHICS_API_.v18.vcxproj", "{_GTAPPLICATIONSAPI_GUID_}"
EndProject
Global
...
std::string const TemplateV18::msProjectLines =
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    ...
    <RootNamespace>_PROJECT_NAME_.v18</RootNamespace>
  ...
  <ItemGroup>
    <ProjectReference Include="_GTE_RELATIVE_PATH_GTApplications_GRAPHICS_API_.v18.vcxproj">
      <Project>{_GTAPPLICATIONSAPI_GUID_}</Project>
    </ProjectReference>
    <ProjectReference Include="_GTE_RELATIVE_PATH_GTGraphics.v18.vcxproj">
      <Project>{_GTGRAPHICS_GUID_}</Project>
    </ProjectReference>
    <ProjectReference Include="_GTE_RELATIVE_PATH_GTGraphics_GRAPHICS_API_.v18.vcxproj">
...
std::string const TemplateV18::msFilterLines =
R"raw(<?xml version="1.0" encoding="utf-8"?>
