...
class TemplateV18 : public Template
{
public:
    TemplateV18(std::string const& gteRelativePath);
    virtual ~TemplateV18() = default;

private:
    virtual std::string GetMSVSVersion() const { return "v18"; }
